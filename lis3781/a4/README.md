...
4. Link to your lis3781_a4_solutions.sql file—including tables AND data!



[SQL Solutions](docs/sql_solutions.sql)
...
| Report Code | Report Output |
|-------------------------|-------------------------|
| ![Report Code](img/report_code.png) | ![Report Output](img/report_output.png) |
